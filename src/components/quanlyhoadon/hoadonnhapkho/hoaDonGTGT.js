...
import CalendarHoaDonGTGT from "./calendarHoaDonGTGT";
import FormNhapHoaDonGTGT from "./formNhapHoaDonGTGT";
...
const { TabPane } = Tabs;
export default function HoaDonGTGT({
  listDanhSacHoaDonGTGT,
  checkFormEdit,
  handleEdit,
  handleBackForm,
  onSave,
  ...
  return (
    <>
      <CalendarHoaDonGTGT setCheckFormEdit={setCheckFormEdit} />
      <hr />
      <Tabs defaultActiveKey="1" tabPosition="left" style={{ height: "100%" }}>
        {listDanhSacHoaDonGTGT.map((item, index) => {
          ...
          return (
            <>
              <TabPane tab={item.so} key={index}>
                {checkFormEdit ? (
                  <FormNhapHoaDonGTGT
                    handleBack={handleBackForm}
                    checkEdit={checkFormEdit}
                    onSave={onSave}
                  />
                ) : (
                  <>
